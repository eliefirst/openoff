...
class Export
{
    ...
    public function execute($orderCollection)
    {
        ...
        foreach ($orderCollection as $order) {
            ...
            $content .= 'ONF_CP_L = ' . $billingAddress->getPostcode() . $eol;
            ...
            $content .= 'ONF_TEL_L = ' . $billingAddress->getTelephone() . $eol;
            ...
            foreach ($items as $item) {
                ...
                if (isset($options["options"])) {
                    ...
                    $content .= 'LIBELLE = ' . str_replace($toReplaceList, $replacementList, $itemName) . ' ';
                    foreach ($options["options"] as $option) {
                        $content .= str_replace($toReplaceList, $replacementList, $option['value']) . ' ';
                    }
